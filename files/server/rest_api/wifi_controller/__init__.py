...
from .rest_controller import bp, WifiStatusApi, BoxRadioStatsApi, BoxRadioAirStatsApi, ConnectedStationsStatsApi
...
bp.add_url_rule("/wifi/stations/stats", view_func=ConnectedStationsStatsApi.as_view("wifi_box_stations_stats_api"))
