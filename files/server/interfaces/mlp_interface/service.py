    ...
    def perform_inference(
        ...
        for station_data in stations_data:
            ...
            logger.debug(
                ...
                f"box_data.tx_err_pps:{box_data.tx_err_pps}  "
                ...
                f"station_data.inactive:{station_data.inactive}  "
                ...
                f"station_data.tx_ber:{station_data.tx_ber}  ",
                ...
                f"station_data.tx_Mbps_avg7:{station_data.tx_Mbps_avg7}  ",
                f"station_data.rx_Mbps_avg7:{station_data.rx_Mbps_avg7}  ",
                f"station_data.signalStrength_avg7:{station_data.signalStrength_avg7}  ",
                f"station_data.tx_Mbps_avg10:{station_data.tx_Mbps_avg10}  ",
                f"station_data.rx_Mbps_avg10:{station_data.rx_Mbps_avg10}  ",
                f"station_data.signalStrength_avg7:{station_data.signalStrength_avg10}  ",
            )
           ##################################################
            data.append(
                [
